...
if __name__ == "__main__":
    dataloader = get_lfw_dataloader(eval_root_dir=None, eval_pairs_path=None, eval_batch_size=None)
    print(dataloader)
    for data in dataloader.create_dict_iterator():
        print("img1", data["img1"].shape)
        print("img2", data["img2"].shape)
        print("issame", data["issame"].shape)
        print("\n")
