...
if __name__ == '__main__':
    data_loaders, data_size = get_dataloader("D:/Desktop/Mindspore/facenet-master/datasets/train/",
                                             "D:/Desktop/Mindspore/facenet-master/datasets/train/",
                                             "D:/Desktop/Mindspore/facenet-master/datasets/train/vggface2.csv",
                                             "D:/Desktop/Mindspore/facenet-master/datasets/train/vggface2.csv",
                                             100, 100,
                                             5, 1,
                                             4, 0,
    ...
    print(data_loaders['train'].get_dataset_size())
    epochs = 2
    iters = data_loaders['train'].create_dict_iterator(num_epochs=epochs)
    for _ in range(epochs):
        print(60 * "=")
        for data in iters:
            print("anc_img", data["anc_img"].shape)
            print("pos_img", data["pos_img"].shape)
            print("neg_img", data["neg_img"].shape)
            print("\n")
